...
% TODO: Abstract
\begin{abstract}
The early detection of skin lesions is crucial for the treatment of severe diseases, such as skin cancer. However, these lesions are usually only diagnosed by dermatologists. Given that these professionals are not always available in regions with less healthcare infrastructure, it would be useful to have a tool capable of skin lesion classification and medical report generation. In this work, we fine-tuned LLaMA 3.2 11B
\end{abstract}
